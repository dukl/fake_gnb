...
namespace ngap{
	...
	{
		if(!pduSessionResourceSetupResponsePdu) pduSessionResourceSetupResponsePdu = (Ngap_NGAP_PDU_t*)calloc(1, sizeof(Ngap_NGAP_PDU_t));
		...
		if(pduSessionResourceSetupResponsePduTypeIE.getProcedureCode()==Ngap_ProcedureCode_id_PDUSessionResourceSetup && pduSessionResourceSetupResponsePduTypeIE.getTypeOfMessage()==Ngap_NGAP_PDU_PR_successfulOutcome && pduSessionResourceSetupResponsePduTypeIE.getCriticality()==Ngap_Criticality_reject)
		{
	...
	void PduSessionResourceSetupResponseMsg::setPduSessionResourceSetupResponseList(std::vector<PDUSessionResourceSetupResponseItem_t>list)
	{
		...
		ret = ASN_SEQUENCE_ADD(&pduSessionResourceSetupResponseIEs->protocolIEs.list, ie);
    	if( ret != 0) cout<<"encode PDUSessionResourceSetupListSURes IE error"<<endl;
	...
	void PduSessionResourceSetupResponseMsg::setPduSessionResourceFailedToSetupList(std::vector<PDUSessionResourceFailedToSetupItem_t>list)
	{
		...
		ret = ASN_SEQUENCE_ADD(&pduSessionResourceSetupResponseIEs->protocolIEs.list, ie);
    	if( ret != 0) cout<<"encode PDUSessionResourceFailedToSetupListSURes IE error"<<endl;

...
namespace ngap{
	...
	void GBR_QosInformation::setGBR_QosInformation(long m_maximumFlowBitRateDL,long m_maximumFlowBitRateUL,long m_guaranteedFlowBitRateDL,long m_guaranteedFlowBitRateUL,
	...
	bool GBR_QosInformation::getGBR_QosInformation(long &m_maximumFlowBitRateDL,long &m_maximumFlowBitRateUL,long &m_guaranteedFlowBitRateDL,long &m_guaranteedFlowBitRateUL,
											 				 NotificationControl *&m_notificationControl,PacketLossRate *&m_maximumPacketLossRateDL,PacketLossRate *&m_maximumPacketLossRateUL)
	{
	...
	bool GBR_QosInformation::decodefromGBR_QosInformation(Ngap_GBR_QosInformation_t *gBR_QosInformation)
	{
		...
		if(gBR_QosInformation->notificationControl)
		{
			...
			if(!notificationControl->decodefromNotificationControl(gBR_QosInformation->notificationControl)) return false;
		}
		if(gBR_QosInformation->maximumPacketLossRateDL)
		{
			maximumPacketLossRateDL = new PacketLossRate();
			if(!maximumPacketLossRateDL->decodefromPacketLossRate(gBR_QosInformation->maximumPacketLossRateDL)) return false;
		}
		if(gBR_QosInformation->maximumPacketLossRateUL)
		{
			maximumPacketLossRateUL = new PacketLossRate();
			if(!maximumPacketLossRateUL->decodefromPacketLossRate(gBR_QosInformation->maximumPacketLossRateUL)) return false;
		}

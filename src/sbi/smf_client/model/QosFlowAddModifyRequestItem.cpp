...
void QosFlowAddModifyRequestItem::fromJson(const web::json::value& val)
{
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("qosRules"));
        if(!fieldValue.is_null())
        {
...
void QosFlowAddModifyRequestItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void QosFlowAddModifyRequestItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void QosFlowAddModifyRequestItem::setQosFlowDescription(const utility::string_t& value)
{
...
std::shared_ptr<QosFlowProfile> QosFlowAddModifyRequestItem::getQosFlowProfile() const
{
    return m_QosFlowProfile;
}

void QosFlowAddModifyRequestItem::setQosFlowProfile(const std::shared_ptr<QosFlowProfile>& value)
{

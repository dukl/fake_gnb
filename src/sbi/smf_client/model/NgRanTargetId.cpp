...
web::json::value NgRanTargetId::toJson() const
{
    ...
    val[utility::conversions::to_string_t("ranNodeId")] = ModelBase::toJson(m_RanNodeId);
...
void NgRanTargetId::fromJson(const web::json::value& val)
{
    ...
    newRanNodeId->fromJson(val.at(utility::conversions::to_string_t("ranNodeId")));
...
void NgRanTargetId::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    m_RanNodeId->toMultipart(multipart, utility::conversions::to_string_t("ranNodeId."));
    m_Tai->toMultipart(multipart, utility::conversions::to_string_t("tai."));
}

void NgRanTargetId::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    std::shared_ptr<GlobalRanNodeId> newRanNodeId(new GlobalRanNodeId());
    newRanNodeId->fromMultiPart(multipart, utility::conversions::to_string_t("ranNodeId."));
    setRanNodeId( newRanNodeId );
    std::shared_ptr<Tai> newTai(new Tai());
...
void NgRanTargetId::setRanNodeId(const std::shared_ptr<GlobalRanNodeId>& value)
{
    m_RanNodeId = value;

...
{
    setUplink(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("uplink"))));
    setDownlink(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("downlink"))));
}
...
void Ambr::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    setUplink(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("uplink"))));
    setDownlink(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("downlink"))));
}

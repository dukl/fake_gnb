...
void PduSessionCreateError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PduSessionCreateError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void PduSessionCreateError::setError(const std::shared_ptr<ProblemDetails_2>& value)
{
    m_Error = value;
...
std::shared_ptr<RefToBinaryData> PduSessionCreateError::getN1SmInfoToUe() const
{
    return m_N1SmInfoToUe;
}

void PduSessionCreateError::setN1SmInfoToUe(const std::shared_ptr<RefToBinaryData>& value)
{

...
public:
    ...
    void setQosFlowsRelNotifyList(const std::vector<std::shared_ptr<QosFlowItem>>& value);
    ...
    void setQosFlowsNotifyList(const std::vector<std::shared_ptr<QosFlowNotifyItem>>& value);
    ...
    void setNotifyList(const std::vector<std::shared_ptr<PduSessionNotifyItem>>& value);

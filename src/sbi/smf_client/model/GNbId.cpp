...
{
    setBitLength(ModelBase::int32_tFromJson(val.at(utility::conversions::to_string_t("bitLength"))));
    setGNBValue(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("gNBValue"))));
}
...
void GNbId::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    setBitLength(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("bitLength"))));
    setGNBValue(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("gNBValue"))));
}

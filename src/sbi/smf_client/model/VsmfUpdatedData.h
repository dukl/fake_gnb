...
public:
    ...
    void setQosFlowsAddModList(const std::vector<std::shared_ptr<QosFlowItem>>& value);
    ...
    void setQosFlowsRelList(const std::vector<std::shared_ptr<QosFlowItem>>& value);
    ...
    void setQosFlowsFailedtoAddModList(const std::vector<std::shared_ptr<QosFlowItem>>& value);
    ...
    void setQosFlowsFailedtoRelList(const std::vector<std::shared_ptr<QosFlowItem>>& value);
    ...
    void setAssignedEbiList(const std::vector<std::shared_ptr<EbiArpMapping>>& value);

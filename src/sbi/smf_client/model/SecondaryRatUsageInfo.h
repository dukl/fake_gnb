...
public:
    ...
    void setQosFlowsUsageData(const std::vector<std::shared_ptr<QosFlowUsageReport>>& value);
    ...
    void setPduSessionUsageData(const std::vector<std::shared_ptr<VolumeTimedReport>>& value);

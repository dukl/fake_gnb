...
void PduSessionNotifyItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PduSessionNotifyItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<NotificationCause> PduSessionNotifyItem::getNotificationCause() const
{
    return m_NotificationCause;
}

void PduSessionNotifyItem::setNotificationCause(const std::shared_ptr<NotificationCause>& value)
{
